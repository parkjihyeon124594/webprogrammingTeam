...
@Builder
public record ProgramIdReadResponse(String memberEmail, String title, String writingTime, String content, Category category, int maximum, String recruitmentStartDate, String recruitmentEndDate, String programDate, Open open, List<String> images) {
}
