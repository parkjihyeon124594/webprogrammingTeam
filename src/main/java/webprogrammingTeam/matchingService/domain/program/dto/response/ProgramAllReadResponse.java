...
@Builder
public record ProgramAllReadResponse(Long id, String title, Category category, Open open, String writingTime, String imageUrl, int recruitment, double avgRating, int ratingCnt, Long publicChannelId) {
}
