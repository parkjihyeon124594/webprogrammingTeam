...
public class EmailConfig {
    ...
    public JavaMailSender mailSender() {//JAVA MAILSENDER 인터페이스를 구현한 객체를 빈으로 등록하기 위함.
        ...
        mailSender.setUsername("gwajegogeubwebpeulogeulaeming@gmail.com");//구글계정을 넣습니다.
        mailSender.setPassword("lgxx soat ccqc kqpg");//구글 앱 비밀번호를 넣습니다.
  ...
  /*  @Bean
    public JavaMailSender mailSender(){//JAVA MAILSENDER 인터페이스를 구현한 객체를 빈으로 등록하기 위함.
        ...
        mailSender.setUsername("haha0888");//네이버 ID를 넣습니다.
        mailSender.setPassword("");//네이버 비밀번호를 넣습니다.g
